...
class Pipeline:
    def __init__(
        ...
        Args:
            ...
            vector_store_type: 'chroma' or None.
            vector_store_path: Path for local vector stores.
            llm: An instance of an LLM class (e.g. OpenAIAgent).
        """
        self.nlp = SpacyEngine() if enable_spacy else None
    ...
    def query(self, question: str, top_k: int = 3) -> Dict[str, Any]:
        ...
        if self.llm:
            ...
            print("Querying LLM...")
            # Using generate method from LLMBase/Agent
